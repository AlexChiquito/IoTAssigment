...
public class CarServiceController {
	...
	@ResponseBody public sensorData getCarById() {
		Random rand = new Random();
		System.out.println("servicio");
		sensorData rSensorData = new sensorData(rand.nextInt(500), "EngineRPM", System.currentTimeMillis());
		JsonObject json = new JsonObject();
        json.addProperty("sensortype","EngineRPM");
        json.addProperty("timestamp", System.currentTimeMillis());
        json.addProperty("data",rand.nextInt(500));
