package eu.arrowhead.client.skeleton.provider.influxImplementation;

import com.google.gson.JsonArray;
import com.google.gson.JsonObject;
import eu.arrowhead.client.skeleton.provider.DatabaseAuthorisation;
import eu.arrowhead.client.skeleton.provider.IDatabase;
import eu.arrowhead.client.skeleton.provider.tools.JsonTools;
...
public class InfluxDatabase extends IDatabase {
  ...
  public JsonArray requestData(JsonObject request) {
    try{
      ...
      Query query = new Query("SELECT * FROM "+request.get("columnName") + "ORDER BY desc LIMIT "+request.get("nPoints").getAsInt(), dbAuth.getDbName());
      connect();
